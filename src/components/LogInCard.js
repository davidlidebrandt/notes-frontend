...
export default function LogInCard() {
    return (
        <form className="col-span-12 sm:col-span-10 sm:col-start-2 md:col-span-8 md:col-start-3 lg:col-span-6 lg:col-start-4 xl:col-span-4 xl:col-start-5 blue-green-gradient rounded opacity-95 mt-36 mb-16 px-5 custom-b-shadow">
            ...
            <button className="block m-auto text-center yellow-bg opacity-80 border font-bold text-2xl py-3 w-2/6 rounded border mt-12">Help</button>
        </form>
    ) 
}
